...
├── docs/
│   ├── GenAI_RAG_VectorSearch_Assessment.pdf
...
The `app/{controller,dto,dependencies,services,configurations,constants}`
layered split mirrors the reference project
[`bigdata/onticai/semantic_search`](../../code/bigdata/onticai/semantic_search).
